...
Built from [Peasypdf](https://peasypdf.com), a free online toolkit.
...
|----------|---------|---------|
| **PyPI** | [peasy-pdf](https://pypi.org/project/peasy-pdf/) | `pip install peasy-pdf` |
| **npm** | [peasy-pdf](https://www.npmjs.com/package/peasy-pdf) | `npm install peasy-pdf` |
| **RubyGems** | [peasy-pdf](https://rubygems.org/gems/peasy-pdf) | `gem install peasy-pdf` |
| **Homebrew** | [peasytools/peasy](https://github.com/peasytools/homebrew-peasy) | `brew install peasytools/peasy/peasy-pdf` |
